...
//    Response postHrrbacRoles(@HeaderParam("X-Instance-Id") String xInstanceId,
//                             @HeaderParam("Authorization") String authorization,
//                             @HeaderParam("Content-Type") String contentType, HrrbacRolesPostApplicationJson entity);
    ...
    List<Pet> findPetsByStatus(@QueryParam("status") List<String> status);
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 405, message = "Invalid input")})
    void updatePetWithForm(@PathParam("petId") Long petId, @Multipart(value = "name", required = false) String name, @Multipart(value = "status", required = false) String status);
    ...
    ModelApiResponse uploadFile(@PathParam("petId") Long petId, @Multipart(value = "additionalMetadata", required = false) String additionalMetadata, @Multipart(value = "file", required = false) Attachment fileDetail);
}
